...
pose_vector = torch.tensor([[0.0000,  0.0000,  0.0524,  0.0000,  0.0000, -0.0524,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000, -0.7854,
          0.0000,  0.0000,  0.9076,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,
          0.0000,  0.0000,  0.0000,  0.0000,  0.0000]], dtype=torch.float32)
pose_axis_angle = pose_vector.view(1, -1, 3)

pose_rotation_matrices = axis_angle_to_matrix(pose_axis_angle)
...
if __name__ == "__main__":
    ...
    pose_rotation_matrices = pose_rotation_matrices.to(device)
    ...
    for data in pbar:
        ...
        print('optimed_pose.shape', optimed_pose.shape)
        # optimed_pose = pose_rotation_matrices.to(device)
        ...
        optimed_pose_mat = pose_rotation_matrices
        ...
        for i in loop_smpl:
            ...
            if dataset_param["hps_type"] != "pixie": ## It seems that icon do not estimated smpl with existing method in an end to end way.
                # print('dataset_param["hps_type"] != "pixie"')
                # print('dataset_param["hps_type"]', dataset_param["hps_type"])
                smpl_out = dataset.smpl_model(
                    betas=optimed_betas,  #[1, 23, 3, 3]
